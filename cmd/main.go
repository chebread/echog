...
// echo
// - 하나 이상의 문자열 인자를 받음
// - 각 인자들을 단일 공백(' ')으로 구분하여 합침
// - 합쳐진 문자열의 끝에 줄바꿈 문자('\n')를 추가함
// - 최종 결과를 표준 출력에 출력함
// - -n 옵션: 출력의 마지막에 자동으로 추가되는 줄바꿈 문자를 생략함

// TODO: TGPL echo 예제 공부하기

// TGPL 공부 순서
// -> TGPL 개념 완벽 공부
// -> TGPL 속 예제 완벽 공부(일단 예제 프로그램 막코딩으로 구현
// -> 그 다음 책보고 예제 공부)
// -> TGPL 속 예제 문제 풀이
// -> TGPL 간단 정리
...
func main() {
	...
	if *ePtr {
		// TODO: regex 사용해서 str 에서 내포된 \x를 \\x로 치환해야 한다.
		str = "\"" + str + "\""
